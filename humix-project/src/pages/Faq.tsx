...
const faqData: FAQItem[] = [
  // 1. 서비스 정체성 및 차별점
  {
    ...
    answer:
      "기존 AI 서비스들은 텍스트 문장으로만 명령할 수 있어 머릿속의 구체적인 멜로디 아이디어를 세밀하게 반영하기 어려웠습니다. 반면 Humix는 사용자가 녹음한 '허밍 멜로디'를 곡의 중심 뼈대로 고정한 채 편곡을 진행합니다. 또한, 한 번 생성되면 수정이 불가능한 기존 서비스와 달리, 마우스 드래그로 음정과 박자를 직접 고칠 수 있는 '선 기반의 쌍방향 에디터'를 제공한다는 점이 가장 큰 차별점입니다.",
  },
  {
    id: "faq-2",
    category: "identity",
    ...
    answer:
      "당연히 가능합니다! Humix는 작곡 경험이 없는 일반인을 주요 대상으로 설계되었습니다. 마이크에 대고 가볍게 흥얼거리기만 해도, AI가 배경 소음을 차단하고 정교한 음 높이 데이터(MIDI 벡터)로 변환해 줍니다. 음정이 조금 불안정하거나 박자를 놓쳤더라도, 화면에 그려지는 선(Pitch Curve)을 마우스로 슥슥 움직여 올바른 음으로 쉽게 교정하고 작곡을 시작할 수 있습니다.",
  },
  // 2. 저작권 및 상업적 이용
  {
    id: "faq-3",
    ...
    answer:
      "Humix를 통해 생성된 곡의 저작권은 원천 아이디어(허밍)를 제공한 사용자 여러분에게 귀속됩니다. 음악 저작권법상 화성 진행이나 작곡 기법 자체는 보호 대상에서 제외되며, 구체적인 선율(멜로디) 표현이 보호받기 때문입니다. 본인의 고유한 허밍을 기반으로 생성된 결과물은 고유 저작물로 인정받을 가능성이 매우 높으며, 구독 요금제 조건에 따라 유튜브, 숏폼 등에서 상업적으로 자유롭게 활용하실 수 있습니다.",
  },
  {
    id: "faq-4",
    category: "copyright",
    ...
    answer:
      "안심하고 사용하셔도 됩니다. Humix는 참고 음원을 업로드하더라도 기성곡의 멜로디 라인은 철저히 배제하고 추출합니다. 오직 그 곡이 가진 음색, 공간감, 주파수 대역 등의 '음향적 질감'만 분석하여 사용자의 고유 멜로디에 입혀주는 방식을 취하므로, 표절 시비를 완벽히 피하면서 원하는 음악적 무드를 안전하게 투영할 수 있습니다.",
  },
  // 3. 기술적 사양 및 기능 안내
  {
    id: "faq-5",
    ...
    answer:
      "시스템의 안정적인 분석을 위해 녹음 길이는 최소 3초에서 최대 60초까지 지원합니다. 주변 소음이 심할 경우 분석 효율이 떨어질 수 있으므로 가급적 조용한 환경(SNR 10dB 이상 권장)에서 가창해 주시는 것이 좋습니다. 포맷은 WAV, MP3를 지원하며, 인식 범위는 일반적인 가창 대역인 C2부터 C6까지 정밀하게 추적합니다.",
  },
  {
    id: "faq-6",
    category: "specs",
    ...
    answer:
      "허밍을 멜로디 벡터로 변환하는 과정은 3초 이내에 완료되며, 최종 AI 곡 완성은 약 10초 ~ 30초 내외가 소요됩니다. 고부하 연산 처리를 위해 GPU 기반 비동기 작업 큐 시스템을 도입하였으며, 기다리시는 동안 실시간 진행률(%) 피드백 화면을 통해 작업 상황을 직관적으로 확인하실 수 있습니다.",
  },
  {
    id: "faq-7",
    category: "specs",
    ...
    answer:
      "아닙니다! Humix의 핵심 차별점 중 하나인 '부분 수정(In-painting)' 기능을 활용해 보세요. 완성된 곡의 타임라인 파형 위에서 마음에 들지 않는 특정 구간(최소 1마디 이상)을 마우스로 드래그하여 선택한 뒤, 새로운 프롬프트를 입력하면 전체 틀을 깨지 않고 해당 구간만 정교하게 재생성하여 자연스럽게 합성해 줍니다.",
  },
];
